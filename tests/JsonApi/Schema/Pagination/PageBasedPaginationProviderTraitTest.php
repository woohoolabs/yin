...
class PageBasedPaginationProviderTraitTest extends TestCase
{
    ...
    public function getSelfLinkWhenPathIsProvided(): void
    {
        ...
        $this->assertEquals("https://example.com/api/users?page[number]=1&page[size]=10", urldecode($href));
    }
    ...
    public function getSelfLinkWhenPathAndAdditionalQueryStringIsProvided(): void
    {
        ...
        $this->assertEquals("https://example.com/api/users?a=c&b=d&page[number]=1&page[size]=10", urldecode($href));
    }
    ...
    public function getSelfLinkWhenPathWithQueryStringIsProvided(): void
    {
        ...
        $this->assertEquals("https://example.com/api/users?a=b&page[number]=1&page[size]=10", urldecode($href));
    }
    ...
    public function getLastLink(): void
    {
        ...
        $this->assertEquals("https://example.com/api/users?page[number]=5&page[size]=10", urldecode($href));
    }
    ...
    public function getPrevLinkWhenPageIsLast(): void
    {
        ...
        $this->assertEquals("https://example.com/api/users?page[number]=4&page[size]=10", urldecode($href));
    }
    ...
    public function getNextLink(): void
    {
        ...
        $this->assertEquals("https://example.com/api/users?page[number]=3&page[size]=10", urldecode($href));
    }
